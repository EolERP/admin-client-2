<script lang="ts">
    ...
    const customerPhotoContent = null;
    export let customer: CustomerDetail = {} as CustomerDetail;
</script>
            ...
            <!--
                  <span class="hidden sm:block">
                   <button
                       ...
                       on:click|preventDefault={()=>{ push(urls.customer.edit, id) }}
                   >
                    <svg
            ...
            <span class="sm:ml-3">
                <button
                    ...
                    on:click|preventDefault={() => {
                        push(urls.customer.edit, customer.id);
                    }}
                >
                    <svg
                        class="-ml-1 mr-2 h-5 w-5 text-gray-500"
